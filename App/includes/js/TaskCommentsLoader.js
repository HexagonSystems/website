...
{
	 $.post( ajaxUrl, { request: "addHours", taskId: taskId, memberId: 1, workedDate: "03/10/2013", workedHours: workedHours, workedComment: workedComment}, 
		 		function( data )
		 	    {
					    if(data == "true")
					    {
	    ...
	    $("#addHoursButton").click( function()
	         {
	         	...
	         	addHours(document.getElementById("addHoursDate").value, $("#addHoursHours").val(), $("#addHoursComment").val());
	         });
	});
